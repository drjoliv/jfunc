  ...
  public static class TryT<M extends Witness,A> implements Monad<Hkt<TryT.μ,M>, A>, Hkt2<TryT.μ,M,A> {
    ...
    */
    ...
    public <B> TryT<M, B> apply(
        Applicative<Hkt<drjoliv.fjava.adt.Try.TryT.μ, M>, ? extends F1<? super A, ? extends B>> applicative) {
    ...
    @Override
    public ApplicativePure<Hkt<drjoliv.fjava.adt.Try.TryT.μ, M>> pure() {
      return new ApplicativePure<Hkt<drjoliv.fjava.adt.Try.TryT.μ, M>>(){
        @Override
        public <B> Applicative<Hkt<drjoliv.fjava.adt.Try.TryT.μ, M>, B> pure(B b) {
